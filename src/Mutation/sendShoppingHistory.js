    ...
    await transporter.sendMail({
        from: `Mercado de Residuos <${GMAIL}>`,
            ...
            *[class="gmail-fix"] { display:none!important }
            ...
            <img class="adapt-img" src="https://fcfuovo.stripocdn.email/content/guids/CABINET_57122f4b6a815139d58447fe5897b311bfe29d4a4a01437656d7ee50b8907637/images/unnamed.png" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="560">
            </td>
            </tr>
            </table>
            </td>
            ...
            <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
            <tr>
            <td align="center" class="h-auto" valign="middle" height="91" style="padding:0;Margin:0">
            <h1 style="Margin:0;line-height:46px;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;font-size:38px;font-style:normal;font-weight:normal;color:#010465">
            ...
            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:40px;color:#333333;font-size:20px">
            <u><strong><em>Su Numero de Compra es:</em></strong></u> ${shoppingHistoryadded.operationId}</p>
            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:40px;color:#333333;font-size:20px">
            <u><strong><em>El Estado de su Compra es:</em></strong></u> ${shoppingHistoryadded.status}</p>
            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:40px;color:#333333;font-size:20px">
            <u><strong><em>El Monto Total de su Compra es:</em></strong></u> ${shoppingHistoryadded.totalAmount}</p>
            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:40px;color:#333333;font-size:20px">
            <u><strong>El Metodo de Pago Utilizado es: </strong></u> ${shoppingHistoryadded.paymentMethod}</p>
            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:40px;color:#333333;font-size:20px">
            <u><strong>Gracias por confiar en nosotros</strong></u> </p>
            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:40px;color:#333333;font-size:20px"><br></p>
            </td>
            </tr>
            </table>
            </td>
